...
namespace Portfolio.Entities.Collections
{
    ...
    public readonly struct Bitmask255 : IEquatable<Bitmask255>
    {
        ...
        public bool Equals(Bitmask255 other)
        {
            return
                _mask0 == other._mask0 &&
                _mask1 == other._mask1 &&
        ...
        {
            return obj is Bitmask255 other && Equals(other);
        }
        ...
        public static bool operator ==(Bitmask255 left, Bitmask255 right)
        {
